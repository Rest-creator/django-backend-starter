...
class ClientService:
    ...
    def create_client(self, *, agent_id: int, full_name: str, national_id: str, contact: str) -> ClientEntity:
        # Add domain validations (e.g., formatting/length) if needed
        return self.client_repo.create(
            full_name=full_name, national_id=national_id, contact=contact, created_by_id=agent_id
        )
